...
public class TableConfig extends PO {
    ...
    @Column(name = "checkable", nullable = false, columnDefinition = "int  default 0 comment '选择'")
    private Integer checkable;
    @Column(name = "row_menu", nullable = false, columnDefinition = "int  default 0 comment '行菜单'")
    private Integer rowMenu;
    @Column(name = "column_filter", nullable = false, columnDefinition = "int  default 0 comment '列过滤器'")
